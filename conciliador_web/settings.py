"""
Django settings for conciliador_web project.
...
SECRET_KEY = 'django-insecure-^-3pdw1c&2296@6q)eg$q)-)jdi_)a6h49s@g8^)f(b!aza5(('
...
STATIC_URL = '/static/'  # Corrección: que empiece y termine con /
